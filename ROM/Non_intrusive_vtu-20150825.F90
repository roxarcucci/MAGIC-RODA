...
contains 
  ...
  subroutine non_intrusive()
   ...
   allocate (xd(podnum,nd)) 
     ...
     ! setting the initial begin
       ...
       volumefraction_initial=> extract_scalar_field(state_initial, "SolidConcentration")
       do i=1,size(POD_state,1)
         do j=1,dimen !velocity%dim 
    ...
    ! visulisation
     ...
     do k=1, numphase 
      ! velocity_field => extract_vector_field(state_show(1), "Velocity" )
       ...
       volumefraction_field=> extract_scalar_field(state(1,s,k), "SolidConcentration" )  
     ...
     call insert(state_show(k), volumefraction_field, "SolidConcentration")
      do d=1,dimen
  ...
  subroutine put_vtu_to_states(state,state_p)
   ...
   !!< 
    ...
    volumefraction=> extract_scalar_field(state(1,1,1), "SolidConcentration")!(state_p(1,1,1), "PhaseVolumeFraction")
    dimen=velocity%dim
   ...
   do p = 1, numphase
    do i = 1, snapshots
       ...
       volumefraction=> extract_scalar_field(state(k,i,p), "SolidConcentration")
       do d = 1, dimen 
